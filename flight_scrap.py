...
# scraping code is from https://github.com/ruihangdu/Airline-Price-Scraper/blob/master/get_airprice.py
...
class Expedia:
    ...
    def search(self, origin_city, destination_city, start_date, return_date):
        ...
        self.driver.quit()
        data_storage.close()
        return depart_time, return_time, carrier, duration, price, satisfactory